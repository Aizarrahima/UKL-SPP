...
<body>
	...
	<hr/>
	<?php 
	$siswa = $conn->query("select * from kelas join siswa on siswa.id_kelas=siswa.id_kelas join spp join pembayaran on pembayaran.nisn=siswa.nisn");
	...
	$spp = mysqli_query($conn, "select * from pembayaran join spp on pembayaran.id_spp=spp.id_spp where tgl_bayar is not null where id_pembayaraan = '".$id_pembayaran."'");
